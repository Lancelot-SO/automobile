        ...
        >
          <Form>
            <Row className="">
              <Col md={3} sm={2} xs={2}>
                <FormGroup>
                  <Label for="brand">Vehicle Condition*</Label>
                  <Input type="select" name="brand" id="brand">
                    {/* Add options for brands */}
                    <option>New Car</option>
                    <option>Old Car</option>
                    <option>Imported Car</option>
                  </Input>
                </FormGroup>
              </Col>
              <Col md={3} sm={6} xs={12}>
                <FormGroup>
                  <Label for="model">Select Brand*</Label>
              ...
              <Col md={3} sm={6} xs={12}>
                <FormGroup>
                  ...
                  <Input type="select" name="parts" id="parts">
                    ...
                    <option>GHC 20,000 - 40,000</option>
                    <option>GHC 10,000 - 20,000</option>
                  </Input>
                </FormGroup>
              </Col>
