...
import RecentlyViewedParts from "../../../components/common/Band/Slider/RecentlyViewedParts";
          ...
          <div className="row g-3">
            <Col>
              ...
              <div className="row g-3 p-2 d-flex justify-content-center gap-2">
                ...
                >
                  <img
                    src="https://demo-egenslab.b-cdn.net/html/drivco/preview/assets/img/inner-page/shop-sm-01.png"
                    alt="steer"
                    style={{
                      borderRadius: "12px",
                    }}
                  ...
                  <Col xs="auto">
                    <Button
                      style={{
                        ...
                        color: "black",
                        width: "",
                        borderRadius: "50%", // Adding rounded corners
                      }}
                      onClick={increment}
                      className="p-3"
                    >
